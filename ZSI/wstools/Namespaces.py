...
class OASIS:
    ...
    class X509TOKEN:
        ...
        X509v3SubjectKeyIdentifier = \
            'http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0#X509v3SubjectKeyIdentifier'
...
class GLOBUS:
    ...
    TOKEN = \
        'http://www.globus.org/ws/2004/09/security/sc#GSSAPI_GSI_TOKEN'
